...
{
	public static Action<DbContextOptionsBuilder> ContextOptionsBuilder(WebApplicationBuilder builder)
	{
		return options =>
		{
			options.UseSqlServer(builder.Configuration.GetConnectionString("DBRContext"), options => options.UseQuerySplittingBehavior(QuerySplittingBehavior.SplitQuery));
